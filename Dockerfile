...
RUN (cd  /opt/sonarqube/extensions/plugins && wget https://sonarsource.bintray.com/Distribution/sonar-java-plugin/sonar-java-plugin-3.11.jar)
...
RUN (cd  /opt/sonarqube/extensions/plugins && wget http://downloads.sonarsource.com/plugins/org/codehaus/sonar-plugins/sonar-scm-git-plugin/1.1/sonar-scm-git-plugin-1.1.jar)
